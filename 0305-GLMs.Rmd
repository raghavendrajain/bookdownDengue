...
form.Optimal <- as.formula("count ~ s(count1,k=4) + s(count8,k=4) + s(count18,k=4) + s(count23,k=4) + s(count25,k=4)")
...
## the formula
form <- as.formula("count ~ s(templ0, k=4) + s(templ1, k=4) + s(templ2,k=4) + s(templ3,k=4) + s(rainl0,k=4) + s(rainl1,k=4) + s(rainl2,k=4) + s(rainl3,k=4) + s(count1,k=4) + s(count8,k=4) + s(count18,k=4) + s(count23,k=4) + s(count25,k=4)")
...
## the formula
form <- as.formula("count ~  s(templ0, k=4) + s(templ1, k=4) + s(templ2,k=4) + s(templ3,k=4) + s(rainl0,k=4) + s(rainl1,k=4) + s(rainl2,k=4) + s(rainl3,k=4) + s(count1,k=4) + s(count8,k=4) + s(count18,k=4) + s(count23,k=4) + s(count25,k=4) + s(surroundingCountVec0,k=4) + s(surroundingCountVec1,k=4) + s(surroundingCountVec2,k=4)  + s(surroundingCountVec3,k=4)")
...
form <- as.formula("count ~  s(templ0, k=4) + s(templ1, k=4) + s(templ2,k=4) + s(templ3,k=4) + s(rainl0,k=4) + s(rainl1,k=4) + s(rainl2,k=4) + s(rainl3,k=4) + s(count1,k=4) + s(count8,k=4) + s(count18,k=4) + s(count23,k=4) + s(count25,k=4) + s(surroundingCountVec0,k=4) + s(surroundingCountVec13,k=4) + s(surroundingCountVec14,k=4)  + s(surroundingCountVec15,k=4)")
...
## the formula
form <- as.formula("count ~ s(templ0, k=4) + s(templ1, k=4) + s(templ2,k=4) + s(templ3,k=4) + s(rainl0,k=4) + s(rainl1,k=4) + s(rainl2,k=4) + s(rainl3,k=4) + s(count1,k=4) + s(count8,k=4) + s(count18,k=4) + s(count23,k=4) + s(count25,k=4) + s(surroundingCountVec0,k=4) + s(surroundingCountVec13,k=4) + s(surroundingCountVec14,k=4)  + s(surroundingCountVec15,k=4)+ offset(log(garbage)) + s(garbage)")
...
plot(pred1.temp, "contour", key.title=title("RR"), plot.title=title("Contour plot",xlab="Dengue Counts",ylab="Lag"))
...
plot(pred1.temp, "contour", key.title=title("RR"), 
     plot.title=title("Contour plot for Surrounding Dengue Influence",xlab="Dengue Counts",ylab="Lag"))
...
title(main="Meteorology, Optimal-term and Short-term Surrounding Lag Model")
...
summary_DMDS_Short <- data.frame("Meteorology, Optimal-term and Short-term Surrounding Lag Model", RMSE_DMDS_Short, SRMSE_DMDS_Short, r.sq_DMDS_Short, dev.expl_DMDS_Short)
...
title(main="Meteorology, Optimal-term and Optimal-term Surrounding Lag Model")
...
summary_DMDS_Optimal <- data.frame("Meteorology, Optimal-term and Optimal-term Surrounding Lag Model", RMSE_DMDS_Optimal, SRMSE_DMDS_Optimal, r.sq_DMDS_Optimal, dev.expl_DMDS_Optimal)
...
preddata <- subset(WholeDataLagged, select = c(templ0, templ1, templ2, templ3, rainl0, rainl1, rainl2, rainl3, count1, count8, count18, count23, count25, surroundingCountVec0, surroundingCountVec13, surroundingCountVec14, surroundingCountVec15))
...
legend('top', c("Observed", "Predicted on Training Set", "Predicted on Validation Set"),lty=1, col=c('black', 'red', "blue"), bty='n', cex=.75)
